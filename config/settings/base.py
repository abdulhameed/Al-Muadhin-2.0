...
ENCRYPTED_FIELD_KEY = config('FIELD_ENCRYPTION_KEY', default=None)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='notifications@almuadhin.com')
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.console.EmailBackend')

ALADHAN_API_BASE_URL = 'https://api.aladhan.com/v1'

ADHAN_AUDIO_BASE_URL = config('ADHAN_AUDIO_BASE_URL', default='/static/audio/')
